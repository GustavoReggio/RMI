...
class MyRob(CRobLinkAngs):
    ...
    def wander(self):
        ...
        print(f'X: {self.pos_estimate.x:.4f} Y: {self.pos_estimate.y:.4f} Ori: {orientation_rad:.4f} Ori_est: {orientation_estimation:.4f}')
        # print(self.measures.beacon)
    ...
    def cheking_X(self,pos):
        match pos:
            ...
            case 'horizontal':
                ...
                print('!! - X - !!')
                self.wall_vertical_pos = self.pos_estimate.x+ distancia_robo
                ...
                self.previous_pos.x =  self.previous_x 
            #----------------------------#
            case 'vertical':
                print('!! - X - !!')
                ...
                #------------------- Left
                self.wall_vertical_pos_l = self.pos_estimate.x -(disancia_l + 0.6)
                ...
                #------------------- Right
                self.wall_vertical_pos_r = self.pos_estimate.x + ( distancia_r + 0.6)
    ...
    def cheking_Y(self,pos):
        match pos:
            ...
            case 'horizontal':
                ...
                #------------------- Left
                print('!! - Y - !!')
                self.wall_horiszoantal_pos_l = self.pos_estimate.y + disancia_l + 0.6
                ...
                #------------------- Right
                self.wall_horiszoantal_pos_r = self.pos_estimate.y -( distancia_r + 0.6)
                ...
                self.previous_pos.y =  self.previous_y 
            #----------------------------#
            case 'vertical':
                print('!! - Y - !!')
                #correctinf sensor                
                if self.front_distance <=1.125:
                    ...
                    distancia_robo = -(self.back_distance + 0.6)
                self.wall_horizontal_pos = self.pos_estimate.y + distancia_robo
